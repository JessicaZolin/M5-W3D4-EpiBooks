...
const AddComment = function ({ asin }) {
    ...
    return (
        <Container>
        <Form onSubmit={sendComment} className="col-12">
            {/* 
            This is the form that the user will use to submit their comment. The form has a single group of elements, which are laid out in a column. The group contains a label and a textarea for the user to enter their comment. It also contains a select element for the user to select their rating. The form also has a single button which will submit the form when clicked. 
            */}
            <Form.Group className="d-flex flex-column justify-content-center">
                {/* 
                This is the label for the comment textarea. It is centered and has a margin of 3px on the bottom. 
                */}
                <Form.Label className="text-center mb-3">Comment</Form.Label>
                {/* 
                ...
                */}
                <Form.Label className="text-center my-3">Rate</Form.Label>
                {/* 
